...
from data_handling import Experience, BufferIterator
...
class DeepQAgent:
    def __init__(self, env: gym.Env, 
        ...
        self._experience = Experience(self.state, 0, 0, 0, self.state)
    ...
    def take_step(self, model: nn.Module):
        ...
        self._experience = Experience(self.state, action, reward, terminated, new_state)
        #
...
class CartPoleDQN(LightningModule):
    ...
    def train_dataloader(self):
        ...
        return DataLoader(dataset=self.agent.experience, batch_size=1)
